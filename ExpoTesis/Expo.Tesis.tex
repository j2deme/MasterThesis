...
% arara: bibtex
% arara: pdflatex: { shell: yes }
% arara: clean: { files: [Expo.Tesis.aux, Expo.Tesis.log, Expo.Tesis.nav, Expo.Tesis.out, Expo.Tesis.snm, Expo.Tesis.toc, Expo.Tesis.idx, Expo.Tesis.ilg, Expo.Tesis.ind, Expo.Tesis.vrb, Expo.Tesis.fdb_latexmk, Expo.Tesis.pyg, Expo.Tesis.bbl, Expo.Tesis.blg]}
