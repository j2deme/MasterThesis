...
% arara: clean: { files: [Tesis.bbl, Tesis.blg, Tesis.out, Tesis.toc, Tesis.loa]}
\documentclass[spanish,ESP,MSc]{cinvestav} %si quieren en espanol, usen spanish, ESP
\usepackage{cite}
\usepackage{slashbox}
...
\titleen{Web Platform for the Analysis of Facial Gestures}
\author{Jaime Jesús Delgado Meraz}
\department{Departamento de Estudios de Posgrado e Investigaci\'{o}n}
\departmenten{Posgraduate Studies and Research Department}
\degreein{Sistemas Computacionales}
\degreeinen{Computer Systems}
\city{Cd. Victoria, Tamaulipas, M\'{e}xico}
\date{\today}
\degreeday{8}
\degreeyear{2013}
\degreemonth{Agosto}
\degreemonthen{August}

\newcommand{\beca}{20120000008}
\acknowledgmenttoproject{
Esta tesis estuvo parcialmente financiada por la beca n\'{u}mero \beca~del ``Programa de Movilidad Nacional 2012 -- 2013''.
}

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

\chair          {Dr. Pedro Luis S\'{a}nchez Orellana}
\member         {Dr. Jos\'{e} Torres Jim\'{e}nez}
